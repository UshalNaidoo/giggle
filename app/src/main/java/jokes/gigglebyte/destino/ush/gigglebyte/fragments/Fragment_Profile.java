...
public class Fragment_Profile extends Fragment implements FragmentLifecycle {
  ...
  public View onCreateView(LayoutInflater inflater,
    ...
    userName.setText(myProfile.getName().isEmpty()
  ...
  private class GetProfile extends AsyncTask<Integer, Integer, String> {
    ...
    protected void onPostExecute(String result) {
      ...
      infoPost.add(new Post(activity.getResources().getString(R.string.info_add_post), BitmapFactory
          .decodeResource(activity.getResources(), R.drawable.plus), PostType.INFO_POST));
      adapter = new PosterProfileListAdapter(activity, posts.size() > 0
                                                       ? posts
                                                       : infoPost, myProfile, FromScreen.USER);
