...
public class UserHelper implements onSubmitListener {
  ...
  public static User getUserDetails(Activity activity) {
    ...
    myProfile.setName(prefs.getString("user_name", activity.getResources()
        .getString(R.string.unknown)));
    myProfile.setId(id);
    myProfile.setDescription(prefs.getString("user_description", activity.getResources()
        .getString(R.string.newUserDescription)));
